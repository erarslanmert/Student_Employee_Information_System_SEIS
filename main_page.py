...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_3 = QtWidgets.QPushButton(Dialog, clicked = lambda : attandence_options.open_attandence())
    ...
    def cell_keep_value(self,row,column):
        ...
        if current_item is not None:
            cell_options.open_cell_options()
        else:
            pass
        if cancel_program == 0:
            if current_item is not None:
